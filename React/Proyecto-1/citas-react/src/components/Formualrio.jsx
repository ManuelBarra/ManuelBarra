  ...
  return (
    <div className="md:w-1/2 lg:w-2/5">
        ...
        <form className="bg-white shadow-md rounded-lg py-10 px-5 mb-10">
          ...
          <div className="mb-5">
            <label htmlFor="propietario" className="block text-gray-700 uppercase font-bold">Nombre de la Propietario</label>
          ...
          <div className="mb-5">
            ...
            <input id="alta" type="date" placeholder="Alta" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"/>
          </div>
          <div className="mb-5">
            <label htmlFor="sintomas" className="block text-gray-700 uppercase font-bold">Email</label>
            <textarea id="sintomas" type="date" placeholder="Describe los Síntomas" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"/>
          </div>
